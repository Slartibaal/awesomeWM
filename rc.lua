...
globalkeys = my_table.join(
    ...
    -- {{{ Personal keybindings
     awful.key({ modkey, "Shift" }, "q", function () awful.util.spawn( "qutebrowser" ) end,
        {description = browser2, group = "MyKeys"}),
...
awful.key({ modkey }, "w", function () awful.util.spawn( browser1 ) end,
 ...
 awful.key({ modkey }, "t", function () awful.util.spawn( "qbittorrent" ) end,
  ...
  awful.key({ modkey,"Shift" }, "m",
    ...
    -- super + ... function keys
     awful.key({ modkey, "Shift" }, "f", function () awful.util.spawn( "flameshot" ) end,
...
awful.key({ modkey, "Shift" }, "F9", function () awful.util.spawn( "urxvt -T 'Mail' -e neomutt" ) end,
    ...
    awful.key({ modkey, "Control" }, "r", function () awful.util.spawn( "rofi -show run" ) end,
        {description = "rofi run", group = "super"}),
   -- awful.key({ modkey }, "t", function () awful.util.spawn( terminal ) end,
    ...
    awful.key({ modkey1, altkey   }, "t", function() awful.util.spawn( "sakura" ) end,
